...
<div class="container " style="background-color:rgba(217, 217, 217, 0.65) ;border-radius: 40px; margin-top:1% ; margin-bottom:2%; padding-top:2%;padding-bottom:5%; padding-left:5%; padding-right:5%;">
    <br>
        ...
        <div class="row">
            ...
            <div class="col-md-4 align-self-end">
                ...
                <div class="form-group text-center">
                    <button id="consulta_ruc" class="btn btn-primary btn-lg" style="margin-left: 190px;background-color:#3B81EB">
                        Consultar RUC
                    </button>
                </div>
            </div>
...
<!-- Campo de Teléfono -->
<div class="form-group mt-0" style="margin-bottom: 40px;">
