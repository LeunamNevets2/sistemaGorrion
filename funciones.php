...
define("PASSWORD_PREDETERMINADA", "ELGORRION");
...
function obtenerVentaPorId($idVenta) {
    // Aquí colocarías tu lógica para obtener la venta por ID
    // (puedes adaptarla según tu implementación actual)
    
    // Supongamos que tienes una conexión a la base de datos en este punto
    $conexion = conectarBaseDatos();

    $consulta = $conexion->prepare("SELECT * FROM ventas WHERE id = :idVenta");
