...
?>
<div class="container">
    <h2 style="margin-bottom: 30px; margin-top: 30px">Reporte de ventas : 
        <?php 
                        ...
                        <table class="table">
                            <?php foreach($venta->productos as $producto) {?>
                                <tr>
                                    ...
                                    <th>S/ <?= $producto->cantidad * $producto->precio ;?></th>
                                </tr>
                            <?php }?>
                        </table>
                    </td>
                    <td>
                        <a href="fpdf/PruebaV.php?id_venta=<?= $venta->id; ?>" target="_blank" class="btn btn-success">
