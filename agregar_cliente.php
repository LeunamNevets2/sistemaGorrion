...
<div class="container " style="background-color:rgba(217, 217, 217, 0.65) ;border-radius: 40px; margin-top:1% ; margin-bottom:2%; padding-top:2%;padding-bottom:6%; padding-left:5%; padding-right:5%;">
    <br>
    <h2 style="margin-bottom: 20px;">Agregar cliente</h2>
    <form method="post">
        <div class="row">
            <div class="col-md-4">
                <div class="dropdown">
            ...
            <div class="col-md-4 align-self-end">
                ...
                <div class="form-group text-center">
                    <button id="consulta_dni" class="btn btn-primary btn-lg" style="margin-left: 190px;background-color:#3B81EB">
                        Consultar DNI
                    </button>
                </div>
            </div>
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col-4">
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="nombres_respuesta" id="nombres_respuesta" class="form-control" readonly>
                </div>
            </div>
            <div class="col-4">
                <div class="form-group mt-3">
                    <label for="ape_p">Apellido Paterno:</label>
                    <input type="text" id="ape_p_respuesta" name="ape_p_respuesta" class="form-control" readonly>
                </div>
            </div>
            <div class="col-4">
                <div class="form-group mt-3">
                    <label for="ape_m">Apellido Materno:</label>
                    <input type="text" name="ape_m_respuesta" id="ape_m_respuesta" class="form-control" readonly>
                </div>
            </div>   
        </div>
        ...
        <div class="row" style="margin-bottom: 40px;">
            <div class="col-md-6">
                <div class="form-group mt-3">
                    ...
                    <input type="tel" name="telefono" class="form-control" id="telefono" placeholder="Ej. 911568974" minlength="7" maxlength="10"  onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                </div>
